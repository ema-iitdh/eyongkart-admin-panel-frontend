...
import { ArrowLeft, MapPin, Phone, Mail, ShoppingCart, Calendar } from 'lucide-react'
...
export function CustomerDetail() {
  ...
  if (error) return <div className="flex justify-center items-center h-screen text-destructive">Error loading customer: {error.message}</div>

  const customer = customers.find((customer) => customer._id === customerId)

  if (!customer) return <div className="flex justify-center items-center h-screen">Customer not found</div>
  ...
  return (
    <div className="container mx-auto px-4 py-2 space-y-8">
      ...
      >
        <ArrowLeft className="w-8 h-8" /> <span className="text-lg">Back to Customers</span>
      </Button>
              ...
              <div key={addr._id} className="space-y-2">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm">
                      {addr.landmark && `${addr.landmark}, `}{addr.district}
                    </p>
                    <p className="text-sm">
          ...
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="flex justify-between text-lg font-semibold">
                ...
                <span>₹{customer.cart.reduce((sum, item) => sum + (item.product.discountedPrice * item.quantity), 0).toFixed(2)}</span>
              </div>
            </div>
          </CardContent>
        </Card>
