...
export function ImageUpload({ images, setImages, multiple = false, maxFiles = 5, title = "Upload Image", description = "Drag 'n' drop some files here, or click to select files" }) {
  const onDrop = useCallback((acceptedFiles) => {
    if (multiple) {
      setImages((prevImages) => {
        const newImages = Array.isArray(prevImages) ? [...prevImages, ...acceptedFiles] : acceptedFiles;
