    ...
    if (multiple && Array.isArray(images)) {
      return images.map((image, index) => (
        <div key={v4()} className="relative group">
          <img
            src={`${CloudinaryConfig.CLOUDINARY_URL}/image/upload/c_fill,w_400,h_400,q_auto,f_auto/${image.url}`}
    ...
    if (!multiple && images) {
      return (
        <div className="relative group">
          <img
            src={`${CloudinaryConfig.CLOUDINARY_URL}/image/upload/c_fill,w_400,h_400,q_auto,f_auto/${images.url}`}
