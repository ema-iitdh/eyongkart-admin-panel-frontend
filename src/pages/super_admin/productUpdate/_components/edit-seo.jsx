...
export function EditSEO({ form }) {
  const [keyword, setKeyword] = useState('')
  
  // Safely get initial values with fallbacks
  const initialKeywords = form.getValues().keywords || []
  const initialMetaTitle = form.getValues().metaTitle || ''
  const initialMetaDescription = form.getValues().metaDescription || ''
          ...
          <FormItem>
            ...
            <FormControl>
              <Input 
                ...
                value={initialMetaTitle} // Handle undefined
